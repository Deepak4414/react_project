    ...
    <div className="home-container">
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 order-lg-1 order-2">
              <div className="hero-content">
                <h1 className="display-4 fw-bold mb-4">Digital Education Platform</h1>
          ...
          <div className="row g-4">
            <div className="col-md-4">
              <div className="feature-card p-4 h-100">
                ...
                <p>Access a wide range of courses across various disciplines with expert-curated content.</p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="feature-card p-4 h-100">
                ...
                <p>Engage with instructors and peers through discussion forums and live sessions.</p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="feature-card p-4 h-100">
      ...
      <section className="cta-section py-5 bg-light">
        <div className="container text-center">
          ...
          <p className="lead mb-4">Join thousands of students already transforming their education.</p>
          <Link 
            to={isLoggedIn ? "/studentindex" : "/"} 
